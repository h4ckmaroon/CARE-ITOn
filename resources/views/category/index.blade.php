        ...
        <div class="box">
            ...
            <div class="box-body dataTable_wrapper">
                                ...
                                @foreach($categories as $category)
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            ...
                                            {!! Form::open(['method'=>'delete','action' => ['ItemCategoryController@destroy',$category->id],'id'=>'del'.$category->id]) !!}
                                            {!! Form::close() !!}
                                        </td>
                                    </tr>
                                @endforeach
                                ...
                                @foreach($deactivate as $category)
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            ...
                                            {!! Form::open(['method'=>'patch','action' => ['ItemCategoryController@reactivate',$category->id],'id'=>'reactivate'.$category->id]) !!}
                                            {!! Form::close() !!}
                                        </td>
                                    </tr>
                                @endforeach
                ...
                <div id="updateModal" class="modal fade">
                    <div class="modal-dialog">
                    {!! Form::open(['method'=>'patch','action' => ['ItemCategoryController@update',0]]) !!}
                        <div class="modal-content">
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">×</span></button>
