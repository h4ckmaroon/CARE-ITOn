...
@section('content')
  ...
  <img src = "data:image/png;base64, {!! base64_encode(QrCode::format('png')->color(38, 38, 38, 0.85)->backgroundColor(255, 255, 255, 0.82)->size(200)->generate('201812')) !!}">  
   <div class="row">
...
@section('scripts')
    ...
    $('#reader').html5_qrcode(function(data){
        ...
        if (data!='') { 
          $.ajax({type: "POST",
                    cache: false,
                    url : "{{action('DashboardController@checkCode')}}",
                    data: {data:data},
                        success: function(data) {
                          console.log(data);
                          if (data==1) {
